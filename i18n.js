...
(function () {
  ...
  const UI = {
    fr: {
      ...
      promo_no_phone: "Renseignez votre téléphone pour utiliser ce code.",
    ...
    en: {
      ...
      promo_no_phone: "Enter your phone number to use this code.",
    ...
    de: {
      ...
      promo_no_phone: "Geben Sie Ihre Telefonnummer ein, um diesen Code zu nutzen.",
