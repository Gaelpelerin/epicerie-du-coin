...
(function () {
  ...
  const UI = {
    fr: {
      ...
      nav_cart: "Panier",
      hero_note:
        "Une envie, une petite faim ? On vous livre chez vous, quand vous voulez, 7j/7 — Le Thillot et 30 km alentour.",
    ...
    en: {
      ...
      nav_cart: "Cart",
      hero_note:
        "Hungry or just craving something? We deliver to your door, whenever you want, 7 days a week — Le Thillot and 30 km around.",
    ...
    de: {
      ...
      nav_cart: "Warenkorb",
      hero_note:
        "Hunger oder einfach Lust auf etwas? Wir liefern zu Ihnen nach Hause, wann immer Sie wollen, 7 Tage die Woche — Le Thillot und 30 km im Umkreis.",
