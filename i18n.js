  ...
  const UI = {
    fr: {
      ...
      checkout_reheat_note:
        "Vos plats sont livrés prêts à réchauffer. Préchauffez votre four 10 à 15 minutes avant dégustation.",
      ...
      msg_stock_insufficient: "Désolé, ces articles ne sont plus disponibles : {items}. Merci de les retirer de votre panier.",
      promo_label: "Code promo",
      promo_ph: "Ex : BIENVENUE10",
      promo_apply: "Appliquer",
      promo_ok: "Code appliqué : −{amount} sur votre commande.",
      promo_invalid: "Code promo invalide.",
      promo_expired: "Ce code promo a expiré.",
      promo_min: "Montant minimum non atteint pour ce code.",
      promo_no_phone: "Renseignez votre téléphone ci-dessus, le −10 % s'applique aussitôt.",
      promo_not_first: "Ce code est réservé à la première commande.",
      cart_promo_title: "Première commande ?",
      cart_promo_sub: "Code BIENVENUE10 : −10 % en un clic",
      checkout_contact_heading: "Vos coordonnées de livraison",
      geo_use: "📍 Utiliser ma position",
      geo_locating: "Localisation en cours…",
      geo_ok: "Position trouvée : adresse pré-remplie.",
      geo_partial: "Position enregistrée. Complétez votre adresse ci-dessus.",
      geo_denied: "Localisation refusée. Saisissez votre adresse à la main.",
      geo_unsupported: "Localisation non disponible sur cet appareil.",
      geo_error: "Localisation impossible. Saisissez votre adresse à la main.",
      ...
      msg_price_changed: "Les prix ont été mis à jour. Rechargez la page, puis validez à nouveau votre panier.",
      checkout_fill_cta: "Complétez vos coordonnées",
      top_sellers_title: "Les plus commandés",
      ...
      delivery_hot: "Chaude, prête à déguster",
      delivery_hot_sub: "recommandé le soir",
      delivery_cold: "À réchauffer chez vous",
      delivery_cold_sub: "four 10 min, à votre rythme",
      msg_choose_delivery_temp: "Merci de choisir un mode de livraison.",
      delivery_when: "Quand souhaitez-vous être livré ?",
      delivery_asap: "Au plus vite",
      delivery_asap_sub: "dès que possible",
      delivery_scheduled: "Planifier",
      delivery_scheduled_sub: "choisir un créneau",
      delivery_asap_note: "On vous confirme l'heure exacte par WhatsApp juste après votre commande.",
      options_edit: "Modifier",
      opt_asap: "Au plus vite",
      opt_scheduled: "Planifié",
      opt_hot: "Chaude",
      opt_cold: "À réchauffer",
      opt_card: "Carte",
      opt_cash: "Espèces",
      f_slot: "Créneau",
      slot_none_today: "Plus de créneau ce soir — choisissez un autre jour",
      delivery_hint_base: "Livraison 7j/7, 24h/24 — au plus vite ou planifiez votre créneau.",
    ...
    en: {
      ...
      checkout_reheat_note:
        "Your dishes are delivered ready to reheat. Preheat your oven 10 to 15 minutes before eating.",
      ...
      msg_stock_insufficient: "Sorry, these items are no longer available: {items}. Please remove them from your cart.",
      promo_label: "Promo code",
      promo_ph: "e.g. BIENVENUE10",
      promo_apply: "Apply",
      promo_ok: "Code applied: −{amount} off your order.",
      promo_invalid: "Invalid promo code.",
      promo_expired: "This promo code has expired.",
      promo_min: "Minimum amount not reached for this code.",
      promo_no_phone: "Enter your phone number above — the −10% applies right away.",
      promo_not_first: "This code is for first orders only.",
      cart_promo_title: "First order?",
      cart_promo_sub: "Code BIENVENUE10: −10% in one click",
      checkout_contact_heading: "Your delivery details",
      geo_use: "📍 Use my location",
      geo_locating: "Locating…",
      geo_ok: "Location found: address pre-filled.",
      geo_partial: "Location saved. Please complete your address above.",
      geo_denied: "Location denied. Please type your address.",
      geo_unsupported: "Location not available on this device.",
      geo_error: "Couldn't locate you. Please type your address.",
      ...
      msg_price_changed: "Prices have been updated. Please reload the page and confirm your cart again.",
      checkout_fill_cta: "Fill in your details",
      top_sellers_title: "Most ordered",
      pay_method: "Payment method",
      pay_card: "Pay now by card",
      pay_cash: "Cash on delivery",
      delivery_method: "Delivery type",
      delivery_hot: "Hot, ready to eat",
      delivery_hot_sub: "recommended in the evening",
      delivery_cold: "Reheat at home",
      delivery_cold_sub: "oven 10 min, at your own pace",
      msg_choose_delivery_temp: "Please choose a delivery type.",
      delivery_when: "When would you like your delivery?",
      delivery_asap: "As soon as possible",
      delivery_asap_sub: "right away",
      delivery_scheduled: "Schedule",
      delivery_scheduled_sub: "pick a time slot",
      delivery_asap_note: "We'll confirm the exact time on WhatsApp right after your order.",
      options_edit: "Change",
      opt_asap: "ASAP",
      ...
      opt_cash: "Cash",
      f_slot: "Time slot",
      slot_none_today: "No slot left tonight — pick another day",
      delivery_hint_base: "Delivery 7 days a week, 24/7 — as soon as possible or schedule a slot.",
    ...
    de: {
      ...
      checkout_reheat_note:
        "Ihre Gerichte werden fertig zum Aufwärmen geliefert. Heizen Sie Ihren Ofen 10 bis 15 Minuten vor dem Verzehr vor.",
      ...
      msg_stock_insufficient: "Leider sind diese Artikel nicht mehr verfügbar: {items}. Bitte entfernen Sie sie aus Ihrem Warenkorb.",
      promo_label: "Aktionscode",
      promo_ph: "z. B. BIENVENUE10",
      promo_apply: "Anwenden",
      promo_ok: "Code angewendet: −{amount} auf Ihre Bestellung.",
      promo_invalid: "Ungültiger Aktionscode.",
      promo_expired: "Dieser Aktionscode ist abgelaufen.",
      promo_min: "Mindestbetrag für diesen Code nicht erreicht.",
      promo_no_phone: "Geben Sie oben Ihre Telefonnummer ein – die −10 % gelten sofort.",
      promo_not_first: "Dieser Code gilt nur für die erste Bestellung.",
      cart_promo_title: "Erste Bestellung?",
      cart_promo_sub: "Code BIENVENUE10: −10 % mit einem Klick",
      checkout_contact_heading: "Ihre Lieferdaten",
      geo_use: "📍 Meinen Standort verwenden",
      geo_locating: "Standort wird ermittelt…",
      geo_ok: "Standort gefunden: Adresse ausgefüllt.",
      geo_partial: "Standort gespeichert. Bitte Adresse oben vervollständigen.",
      geo_denied: "Standort abgelehnt. Bitte Adresse eingeben.",
      geo_unsupported: "Standort auf diesem Gerät nicht verfügbar.",
      geo_error: "Standort nicht möglich. Bitte Adresse eingeben.",
      ...
      msg_price_changed: "Die Preise wurden aktualisiert. Bitte laden Sie die Seite neu und bestätigen Sie Ihren Warenkorb erneut.",
      checkout_fill_cta: "Bitte Kontaktdaten ausfüllen",
      top_sellers_title: "Am häufigsten bestellt",
      pay_method: "Zahlungsart",
      pay_card: "Jetzt per Karte bezahlen",
      pay_cash: "Barzahlung bei Lieferung",
      delivery_method: "Lieferart",
      delivery_hot: "Warm, verzehrfertig",
      delivery_hot_sub: "abends empfohlen",
      delivery_cold: "Zu Hause aufwärmen",
      delivery_cold_sub: "Ofen 10 Min, in Ihrem Tempo",
      msg_choose_delivery_temp: "Bitte wählen Sie eine Lieferart.",
      delivery_when: "Wann möchten Sie beliefert werden?",
      delivery_asap: "So schnell wie möglich",
      delivery_asap_sub: "sofort",
      delivery_scheduled: "Planen",
      delivery_scheduled_sub: "Zeitfenster wählen",
      delivery_asap_note: "Wir bestätigen die genaue Uhrzeit direkt nach Ihrer Bestellung per WhatsApp.",
      options_edit: "Ändern",
      opt_asap: "Sofort",
      opt_scheduled: "Geplant",
      opt_hot: "Warm",
      opt_cold: "Zum Aufwärmen",
      opt_card: "Karte",
      opt_cash: "Bar",
      f_slot: "Zeitfenster",
      slot_none_today: "Heute Abend kein Fenster mehr — wählen Sie einen anderen Tag",
      delivery_hint_base: "Lieferung 7 Tage die Woche, rund um die Uhr — sofort oder Zeitfenster planen.",
