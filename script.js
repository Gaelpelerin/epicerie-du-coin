...
const products = [
  ...
  {
    id: "jus-goyave-litchi",
    name: "Jus goyave - litchi 25 cl",
    category: "jus",
    description: "Boisson à base de purées de goyave et de litchi.",
    price: 3.9,
    icon: "🧃",
    images: ["products/jus-goyave-litchi.jpeg"],
  },
  {
    id: "jus-pomme-kiwi",
    name: "Jus pomme - kiwi 25 cl",
    category: "jus",
    description: "Boisson pomme et kiwi, 50 % de fruits.",
    price: 3.9,
    icon: "🧃",
    images: ["products/jus-pomme-kiwi.jpeg"],
  },
  {
    id: "jus-ananas-gingembre",
    name: "Jus ananas - gingembre 25 cl",
    category: "jus",
    description: "Ananas, pomme, gingembre et citron vert - 96 % de fruits.",
    price: 3.9,
    icon: "🧃",
    images: ["products/jus-ananas-gingembre.jpeg"],
  },
  {
    id: "desperados",
